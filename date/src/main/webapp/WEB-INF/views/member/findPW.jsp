                    ...
                    <div class="panel-body">
	                    <fieldset>
	                        <div class="form-group">
	                        	<label>회원님의 비밀번호</label>
	                        	<c:if test="${password!=null }">
	                            	<input class="form-control" name="password" type="text" value="${password }" disabled="disabled" autofocus/>
	                            </c:if>
	                            <c:if test="${password==null }">
	                            	<h5>해당 정보에 맞는 회원이 없습니다.</h5>
	                            </c:if>
	                        </div> 
	                        <div>
