...
<script type="text/javascript" src="//apis.daum.net/maps/maps3.js?apikey=cd16bfc3926d034f1176275f760bd0ff"></script>
...
daum.maps.event.addListener(map, 'click', function(mouseEvent) {
    ...
    var clickPosition = [{eb:126.56954484802012, fb:33.45025510604883}];
    console.log(mouseEvent.latLng); //db에서 가져와보자1!
