...
<link href="${root}/smarteditor/css/smart_editor2.css" rel="stylesheet" type="text/css">
<style type="text/css">
	body { margin: 10px; }
</style>
<script type="text/javascript" src="${root}/smarteditor/js/jindo.min.js" charset="utf-8"></script>
<script type="text/javascript" src="${root}/smarteditor/js/jindo_component.js" charset="utf-8"></script>
<script type="text/javascript" src="${root}/smarteditor/js/SE2B_Configuration_Service.js" charset="utf-8"></script>	<!-- 설정 파일 -->
<script type="text/javascript" src="${root}/smarteditor/js/SE2B_Configuration_General.js" charset="utf-8"></script>	<!-- 설정 파일 -->
<script type="text/javascript" src="${root}/smarteditor/js/SE2BasicCreator.js" charset="utf-8"></script>

<script src='${root}/smarteditor/js/smarteditor2.js' charset='utf-8'></script>
<script src='${root}/smarteditor/photo_uploader/plugin/hp_SE2M_AttachQuickPhoto.js' charset='utf-8'></script>
</head>
<body>
