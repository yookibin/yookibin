...
<script type="text/javascript">
	function randomFun(root, event_code, group_number, sequence_number, sequence_level, pageNumber){
		//alert("하하하 랜덤추첨!!");
		var num=prompt("몇 명의 당첨자?","");
		//alert(num);
...
<input type="button" value="발표 글 쓰기" onclick="randomFun('${root }','${event_code}','${group_number }','${sequence_number }','${sequence_level }','${pageNumber }')" />
<br/><br/>
