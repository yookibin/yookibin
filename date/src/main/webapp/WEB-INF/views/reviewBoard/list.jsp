						...
						<div class="place_info">
							...
							<div class="detail_content">
								<ul class="place_detail">
									...
									<li>
										<b>예산(2인)</b>
										<span class="red">${placeBoard.place_price}원</span>
									</li>
								</ul>
								...
								<ul class="place_grade">
									<li>
										...
										<c:if test="${placeBoard.place_star>0 && placeBoard.place_star<=0.5}"><img src="${root}/resources/star/05.png" width="113" height="22"/></c:if>
										<c:if test="${placeBoard.place_star>0.5 && placeBoard.place_star<=1}"><img src="${root}/resources/star/10.png" width="113" height="22"/></c:if>
										<c:if test="${placeBoard.place_star>1 && placeBoard.place_star<=1.5}"><img src="${root}/resources/star/15.png" width="113" height="22"></c:if>
										<c:if test="${placeBoard.place_star>1.5 && placeBoard.place_star<=2}"><img src="${root}/resources/star/20.png" width="113" height="22"/></c:if>
										<c:if test="${placeBoard.place_star>2 && placeBoard.place_star<=2.5}"><img src="${root}/resources/star/25.png" width="113" height="22"/></c:if>
										<c:if test="${placeBoard.place_star>2.5 && placeBoard.place_star<=3}"><img src="${root}/resources/star/30.png" width="113" height="22"/></c:if>
										<c:if test="${placeBoard.place_star>3 && placeBoard.place_star<=3.5}"><img src="${root}/resources/star/35.png" width="113" height="22"/></c:if>
										<c:if test="${placeBoard.place_star>3.5 && placeBoard.place_star<=4}"><img src="${root}/resources/star/40.png" width="113" height="22"/></c:if>
										<c:if test="${placeBoard.place_star>4 && placeBoard.place_star<=4.5}"><img src="${root}/resources/star/45.png" width="113" height="22"/></c:if>
										<c:if test="${placeBoard.place_star>4.5 && placeBoard.place_star<=5}"><img src="${root}/resources/star/50.png" width="113" height="22"/></c:if>
									</li>
	...
	<div class="replyDivp">
		<c:if test="${nickName!=null}">
			<div style="float: left">
				<span style="color: #f00; font-weight: bold">평점</span>&nbsp;
				<select id="starReply" style="font-weight: bold;height:20px ">
